...
<head>
    ...
    <title>Daftar Event | K-people</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="indexkuy.php">Beranda</a>
            </li>
            <li class="nav-item">
...
<header class="masthead">
  <div class="container">
    <div class="intro-text">
      ...
      <div class="intro-lead-in">Lets Have fun together through the events</div>            
    </div>
  </div>
</header>
...
<h3>Isi formulir di bawah ini untuk mendaftarkan eventmu</h3>
